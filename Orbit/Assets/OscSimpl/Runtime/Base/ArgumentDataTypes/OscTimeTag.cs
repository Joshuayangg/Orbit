...
/// <summary>
/// Struct representing a OSC timetag.
...
public struct OscTimeTag
{
	...
	{
		_oscNtp = 1; // immediately default is true
		SetTime( time );
	}
	...
	/// <summary>
	/// Create new timetag setting the OSC NTP encoded time directly.
	/// </summary>
	public OscTimeTag( ulong oscNtp )
	{
		_oscNtp = oscNtp;
	}
	...
	void SetTime( DateTime time )
	{
		...
		if( timeDec > ulong.MaxValue ) timeDec = ulong.MaxValue;
	...
	public override string ToString()
	{
		...
		return AppendToString( sb ).ToString();
	}


	public StringBuilder AppendToString( StringBuilder sb )
	{
		return sb.Append( "TimeTag[" ).AppendGarbageFree( _oscNtp ).Append( "]" );
	}
}
